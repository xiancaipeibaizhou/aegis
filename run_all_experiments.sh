...
DATASETS=("darknet2020_block" "cic_ids2017" "unsw_nb15" "ton_iot")

# 2. 定义你要跑的完整模型与消融变体
VARIANTS=("AEGIS" "WoMacro" "WoMicro" "WoSpatialGating" "WoEdgeAug" "FixedTemporal")

# 3. 环境变量设置 (根据显存大小调整 BATCH_SIZE)
export BATCH_SIZE=32
export PRETRAIN_EPOCHS=36
